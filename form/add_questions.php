<?php 
   ...
   if(isset($_POST['pro_btn']))
   {
       ...
       $user_regisstration_query = "INSERT INTO `add_db` (`id`, `add_id`) VALUES (NULL, '$add_id')";
    ...
    opacity: 0.8;
        ...
        <tbody>
               ...
               {    
                  ...
                  //SELECT * FROM `testques`.`questions_set` WHERE `test_id` = 1
   ...
   <table class="coursetable">
      ...
      <tfoot>
            <tr>  
             ...
             <a type="submit" class="btn" href="add_quedb.php" style="text-decoration: none;" value="nextbtn">Next</a>  
            </td> 
            </tr>
      </tfoot>
    </table>
